    ...
    <div style={{ minHeight: '100vh', fontFamily: 'system-ui, sans-serif', color: '#1E1B2E' }}>
      ...
      <div style={{ background: 'linear-gradient(135deg, #EEF2FF 0%, #DBEAFE 50%, #E0F2FE 100%)', padding: '100px 24px' }}>
        <div style={{ maxWidth: 720, margin: '0 auto', textAlign: 'center' }}>
          ...
          <h1 style={{ fontFamily: 'Georgia,serif', fontSize: 56, lineHeight: 1.1, marginBottom: 24, color: '#1E1B2E' }}>
            The world is their classroom.<br/>
            <span style={{ color: '#635BFF' }}>We write the lesson plans.</span>
          </h1>
          <p style={{ fontSize: 20, color: '#4B5563', lineHeight: 1.7, marginBottom: 48, maxWidth: 560, margin: '0 auto 48px' }}>
          ...
          <div style={{ display: 'flex', gap: 16, justifyContent: 'center', flexWrap: 'wrap', marginBottom: 20 }}>
            <button onClick={() => router.push('/auth')} style={{ padding: '18px 40px', borderRadius: 100, border: 'none', background: '#635BFF', color: 'white', fontSize: 18, fontWeight: 800, cursor: 'pointer', fontFamily: 'inherit', boxShadow: '0 8px 24px rgba(99,91,255,0.35)' }}>
              Start 10-day free trial →
            </button>
            <button onClick={() => document.getElementById('features')?.scrollIntoView({ behavior: 'smooth' })} style={{ padding: '18px 40px', borderRadius: 100, border: '2px solid #C7D2FE', background: 'white', color: '#635BFF', fontSize: 18, fontWeight: 800, cursor: 'pointer', fontFamily: 'inherit' }}>
              See how it works
            </button>
          </div>
      ...
      {/* Social proof */}
      <div style={{ background: 'white', padding: '28px 24px', borderBottom: '2px solid #E4E0F5' }}>
